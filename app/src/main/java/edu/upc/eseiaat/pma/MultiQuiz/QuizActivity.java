...
public class QuizActivity extends AppCompatActivity {
    ...
    public static final String ANS_IS_CORRECT = "ans_is_correct";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        //Guardem dades abans de matar l'aplicació
        //L'objecte outstate conté totes les dades
        super.onSaveInstanceState(outState);

        outState.putInt(CORRECT_ANSWER,correct_answer);
        outState.putInt(CURRENT_QUESTION,current_question);
        outState.putBooleanArray(ANS_IS_CORRECT,answer_is_correct);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState==null){
            ...
            answer_is_correct = state.getBooleanArray(ANS_IS_CORRECT);
    ...
    private void checkResults() {
        ...
        String resultado = String.format("Correctas: %d\nIncorrectas: %d\nNo contestadas: %d",
